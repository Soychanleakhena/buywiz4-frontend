      ...
      <header className="border-b">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <a href="/" className="text-2xl font-bold text-blue-600">BuyWiz</a>
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-2">
                <div className="w-5 h-5 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm">✓</div>
              ...
              <div className="flex items-center space-x-2">
                <div className="w-5 h-5 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm">3</div>
                    ...
                    {savedCards.map((card) => (
                      <label key={card.id} className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                        ...
                        <span className="ml-3 flex items-center">
                          {card.brand === 'visa' ? (
                            <svg className="h-8 w-8 mr-2" viewBox="0 0 32 32" fill="none">
                              <rect width="32" height="32" rx="4" fill="#1A1F71"/>
                              <path d="M13.3233 20.2051H10.5097L8.41406 12.7793C8.34056 12.5374 8.19608 12.3244 7.99609 12.1875C7.46761 11.8506 6.88729 11.5904 6.26953 11.4102V11.0957H10.7266C11.2324 11.0957 11.6058 11.4476 11.6709 11.9531L12.7363 17.9238L15.3613 11.0957H18.0742L13.3233 20.2051Z" fill="white"/>
                            </svg>
                          ) : (
                            <svg className="h-8 w-8 mr-2" viewBox="0 0 32 32" fill="none">
